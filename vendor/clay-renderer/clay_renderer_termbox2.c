...
// termbox2.h is already included by clay_termbox_impl.c with TB_IMPL
// Don't re-include it here to avoid redefinition errors
#ifndef TB_IMPL
#define TB_OPT_ATTR_W 32 // Required for truecolor support
#include "termbox2.h"
#endif

// stb headers are already included by clay_termbox_impl.c with IMPLEMENTATION
// Don't re-include them here to avoid redefinition errors
